...
namespace FinancialCalculator.Services.UnitTests
{
    ...
    public class CreditServiceTests
    {
     ...
     decimal? expectedTotalInitialFees)
        {
            // Act
            decimal result = creditService.CalculateInitialFees(loanAmount, applicationFee, applicationFeeType, processingFee, processingFeeType, otherFees, otherFeesType);
        ...
        public void CalculateInitialFees_WithLoanAmountGreaterThanMax_ShouldThrowException()
        {
            ...
            {
                creditService.CalculateInitialFees(loanAmount, applicationFee, FeeType.Currency, processingFee, FeeType.Percentage, otherFees, FeeType.Currency);
        ...
        public void CalculateInitialFees_WithZeroForApplicationFee_ShouldThrowException(decimal applicationFee, FeeType applicationFeeType)
        {
            ...
            Assert.Throws<ArgumentException>(() =>
            {
                creditService.CalculateInitialFees(loanAmount, applicationFee, applicationFeeType, processingFee, processingFeeType, otherFees, otherFeesType);
